							...
							<div class="accordion-item">
								<div id="flush-collapseOne" class="accordion-collapse collapse"
									...
									<div class="accordion-body">
										...
										<c:forEach var="buyItem" items="${buyItems}" varStatus="vs">
											<c:choose>
												<c:when test="${!empty buyItem}">
													...
													<div class="row orderDetail">
														...
														<!-- 留下評價按鈕會跳出一個小視窗 -->
														<c:choose>
															<c:when test="${empty buyItem.commentBean}">
																...
																<form method="POST"
																		...
																		<div class="rateForm col-12 ">
																			...
																			<div>
																				...
																				<br> <input type="hidden" name="custId"
																					...
																					value="${buyItem.buyItemPK.prodSerialNum}" />
																			</div>
																		</div>
																	</div>
																	<div class="modal-body">
																	...
																	<div class="modalBtn modal-footer">
																		...
																		<button type="button" class="btn btn-secondary"
																			data-bs-toggle="modal"
																			data-bs-target="#exampleModal${vs.index}">取消</button>
																	</div>
																</form>
															</div>
														</div>
