...
<script>
	$(document).ready(function() {
		...
		$("#form1").submit(function()  {
		    var form = $(this);
// 		    form.append('replyId', ${customer.account})
			...
			$.ajax({
		        ...
		        success: function(data){
					if(data){
						...
						window.location.href='${pageContext.request.contextPath}/_05_member_management'
					}
		        }
		    });  
		}); 
		...
		<div class="mainHeader" id="content">
			...
			<div class=" col-10 p-3">
				...
				<div class="title col-12 ">
					<h1>
						<i class="fas fa-th-large pe-3"></i>聯絡我們
					</h1>
				</div>
				<!-- title end -->
				...
				<div class="container p-3 ">
					<form class="row g-3 form" method="POST" modelAttribute="problem"
						enctype='multipart/form-data' action="/Whocares/_02_contactUs/"
						id="form1">
						<!-- 功能:登入會員會自動顯示會員帳號/email/電話，未登入的話可以自己key -->
						<!-- account&orderno start -->
						<div class="col-6">
							<label for="inputAccount" class="form-label">會員編號:</label> <input
								type="text" class="form-control" name="account" id="custId"
								path='account' value='${customer.account}'>
						</div>
						<div class="col-6">
						...
						<div class="col-6">
							<label for="inputEmail" class="form-label">Email</label> <input
								...
								path='email' value='${customer.email}'>
						</div>
						<div class="col-6">
							<label for="inputPhone" class="form-label">連絡電話</label> <input
								type="tel" class="form-control" name='phone' id="inputPhone"
						...
						<div class="col-12 w-50 ">
							<label for="inputProblemtype" class="form-label">問題種類:</label> <select
								id="problemType" class="form-select" name="problemType">
						...
						<div class="col-12 ">
							...
							<label for="inputDescription" class="form-label">問題敘述:</label> <br>
						...
						<!-- submit&upload start -->
						<div class="d-flex">
							<button type="submit" class="btn btn-warning me-2" id=buttonus>送出表單</button>
